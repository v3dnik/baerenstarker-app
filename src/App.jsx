    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#1e2d4f,#2f4b88)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ background: 'white', borderRadius: 28, padding: '40px 36px', width: '100%', maxWidth: 420, boxShadow: '0 40px 80px rgba(0,0,0,0.25)' }}>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          {/* Remember me */}
          <label style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer', userSelect: 'none', margin: 0, textTransform: 'none', letterSpacing: 'normal', fontSize: 14, fontWeight: 500, color: '#1a2744' }}>
            <input
              type="checkbox"
              checked={rememberMe}
              onChange={e => setRememberMe(e.target.checked)}
              style={{ width: 18, height: 18, cursor: 'pointer', accentColor: '#1a2744' }}
            />
            Angemeldet bleiben
          </label>
